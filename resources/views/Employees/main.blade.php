    ...
    @section('main-content')
        <div class="w-full h-full flex flex-col">
            <div class="h-10 w-full flex justify-around items-center font-extrabold">
                <a href="{{ url('personnel/mes-demandes') }}" class="border-b-2 border-dotted text-indigo-300 hover:text-indigo-500 hidden lg:block">Mes demandes</a>
                <a href="{{ url('/wanna-work') }}" class="border-b-2 border-dotted block text-indigo-300 hover:text-indigo-500">Travailler</a>          
                <a href="{{ url('personnel/mon-profil/mis-à-jour') }}" class="border-b-2 border-dotted block text-indigo-300 hover:text-indigo-500">Mèttre à jour</a>

    ...
    @section('main-content')
        <div class="w-full h-full flex flex-col">
            <div class="h-10 w-full flex justify-around items-center font-extrabold">
                <a href="{{ url('admin/personnel/listes') }}" class="border-b-2 border-dotted block text-indigo-300 hover:text-indigo-500">&lAarr; Revenir</a>
                <a href="{{ url("personnel/matricule=$moi->matricule/ses-demandes") }}" class="border-b-2 border-dotted text-indigo-300 hover:text-indigo-500 hidden lg:block">Ses demandes</a>
            </div>
            ...
            <div class="flex-1 flex justify-center gap-x-5">
                <div class="h-full lg:w-2/6 w-4/6 gap-y-4 flex flex-col justify-around p-1 overflow-auto">
                    <div class="w-full">
                        <h3 class="font-extrabold text-center">{{ $moi->nom }} informations</h3>
                    </div>

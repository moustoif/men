...
@section('nav')
    ...
    <div class="w-full h-full flex flex-col">
        <div class="h-20 w-full flex justify-around items-center font-extrabold">
            <a href="{{ url('admin/mes-informations') }}" class="border-b-2 border-dotted block text-indigo-300 hover:text-indigo-500">&lAarr; Revenir</a>
            <form action="{{ url('/new-count') }}" method="POST" class="" title="Ajouter le décompte pour l'année">
                @csrf
